...
<html>
    <head>
        ...
        <title>Ficha de Expropiación</title>
...
<body>
  ...
  @include('eliminarReg.anularExpropiacion')
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="panel">
                    ...
                    <div id="panelTitu" class="panel-heading text-center"><h5 id="h5Titu"><b>REGISTRO DE EXPROPIACIÓN</b> <i class="fa fa-file-text-o" aria-hidden="true"></i></h5></div>
                </div>   
            </div>
          ...
          <hr>
                  ...
                  @endif
              	  ...
              	  <div class="col-md-4 form-group">
                 	    <label>Código de Adquisición</label>
                     	    <br>{{$seleccion->selectExpropiacion->opcion}}
                  </div>
                  ...
                  @endif
                   ...
                   @if($seleccion->numSena == '0')
                    <div class="col-md-3 form-group">
                        <label>Número Sentencia o Acto</label>
                          <br>xxx
                    </div> 
                   @else 
                    <div class="col-md-3 form-group">
            ...
            <div class="row text-center separar">
               	<div class="col-md-12 separar form-group">
                     ...
                     <a href="{{url('regExpropiacion')}}"  class="btn btn-success"><i class="fa fa-reply " aria-hidden="true" title="Regresar"></i> <b>Regresar</b></a>
                        
                     <a href="{{url ('expropiacion/'.$seleccion->id) }}/edit" class="btn btn-info" title="Modificar"><i class="fa fa-pencil-square-o" aria-hidden="true"> <b>Modificar</b></i></a> 
               	</div>
            </div>
        </div>
    </div>
