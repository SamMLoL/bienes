      <div class="modal fade" id="AnularT9" name="AnularT9" role="dialog" aria-labelledby="ModalLabel" aria-hidden="false" >
          <div class="modal-dialog">
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                       ...
                       <center>
                       <a href="{{url ('anularEqtransporte/'.$seleccion->id) }}" type="button" class="btn btn-danger"  title="Aceptar"  id="AnularT9"><b>Aceptar</b></a>
