      <div class="modal fade" id="AnularT12" name="AnularT12" role="dialog" aria-labelledby="ModalLabel" aria-hidden="false" >
          <div class="modal-dialog">
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                       ...
                       <center>
                       <a href="{{url ('anularInmu/'.$seleccion->id) }}" type="button" class="btn btn-danger"  title="Aceptar"  id="AnularT12"><b>Aceptar</b></a>
