...
@section('content')
  ...
  <div class="row">
     <div class="panel-heading text-center separar"><h5><b>DATOS DE LOS ORIGENES (FORMAS DE ADQUISICIÓN) DE LOS BIENES MUEBLES E INMUEBLES DEL ORGANO O ENTE</b></h5></div>
  </div>
    ...
    {{ csrf_field() }}
      ...
      @endif
          ...
          @foreach($traeseladqui as $posicion => $valor)
             ...
             <div class="col-md-4 {{$traeseladqui[$posicion][2]}} form-group">
          ...
          @foreach($arrayt2 as $posicion => $valor)
        	    ...
        	    <div class="col-md-4 {{$arrayt2[$posicion][4]}} form-group">
