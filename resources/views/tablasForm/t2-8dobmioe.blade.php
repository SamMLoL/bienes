...
@section('content')
	...
	<div class="row">
	     <div id="panelTitu" class="panel-heading text-center separar"><h5 id="h5Titu"><b>ANEXO T-2-8 / DATOS DE LOS ORIGENES (FORMAS DE ADQUISICIÓN) DE LOS BIENES MUEBLES E INMUEBLES DEL ORGANO O ENTE</b></h5></div>
	</div>
...
<div class="row">
   <div class="col-md-12">
   	  <form role="form" id="formValidaT28" name="formValidaT28" method="POST" action="{{url('t28')}}">
    	{{ csrf_field() }}
