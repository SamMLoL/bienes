...
<div class="row">
   <div class="col-md-12">
  	  <div class="row">
  	     <div id="panelTitu" class="panel-heading text-center separar"><h5 id="h5Titu"><b> <i class="fa fa-file-o" aria-hidden="true"></i> BIENES / DATOS DE LOS COMPONENTES DE LOS BIENES MUEBLES DEL ÓRGANO O ENTE</b></h5></div>
      </div>
