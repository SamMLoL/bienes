  ...
  <div class="col-md-12">
    ...
    <div class="col-md-4 form-group">
      <li>Descripción del Estado del Bien:</li>
          <input type="text" id="descEdoBien" name="descEdoBien" class="form-control" placeholder="Introduzca la descripción del estado del bien" maxlength="200">
    </div>
  ...
  <div class="col-md-12">
    ...
    <div class="col-md-4 form-group">
      <li>Especificación de Color:</li>
          <input type="text" id="espeColor" name="espeColor" class="form-control" placeholder="Especifique el color" maxlength="255">
    </div>

    <div class="col-md-4 form-group">
      <li>Otras Especificación de Color:</li>
          <input type="text" id="otraEspeColor" name="otraEspeColor" class="form-control" placeholder="Introduzca otras especificaciones del color" maxlength="255">
    </div>
  </div>
</div>
  ...
  <div class="col-md-12">
    <div class="col-md-4 form-group">
      <li>Especificaciones Técnicas del Bien:</li>
          <input type="text" id="espeTecBien" name="espeTecBien" class="form-control" placeholder="Introduzca especificaciones técnicas del bien" maxlength="255">
    </div>
