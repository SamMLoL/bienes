...
<div class="row">
   <div class="col-md-12">
    	<div class="row">
    	     <div id="panelTitu" class="panel-heading text-center separar"><h5 id="h5Titu"><b> <i class="fa fa-file-o" aria-hidden="true"></i> PERMUTA / DATOS DE LOS ORIGENES (FORMAS DE ADQUISICIÓN) DE LOS BIENES MUEBLES E INMUEBLES DEL ORGANO O ENTE</b></h5></div>
      </div>
      ...
      <div class="row">
          <div class="col-md-12">
              ...
              @if($lastCod)
                @if($lastCod->codOt2_6 == 'G-1')
                  <center><b id="color"> G-1 </b></center>
                @else
                  <center><b id="color"> {{$lastCod->codOt2_6}}</b></center>
                @endif
              @else
                  <center><b id="color">G2012001</b></center>
              @endif
...
<hr>
   	  ...
   	  <form role="form" id="formValidaT26" name="formValidaT26" method="POST" action="{{url('permuta')}}">
    	{{ csrf_field() }}
