    ...
    <hr>
        ...
        <table id="tablaT1" class="tabla table-striped table-responsive table-bordered table-hover">
          ...
          <tbody style="font-size:12px;">
            @foreach($verS2 as $registro)
                
                @if($registro->cedula == '1') 
                  <tr>
                        @if($registro->revisadoS2 == '1')
                        <td class="text-center"><a href="#" hidden>{{$registro->id}}</a><a href="seleccionMaxima/{{$registro->id}}"><b>Nuevo <i class="fa fa-eye" aria-hidden="true"></i> xxx</b></a></td>
                        @else 
                        <td class="text-center"><a href="#" hidden>{{$registro->id}}</a><a href="seleccionMaxima/{{$registro->id}}"> xxx</a> </td>
                        @endif
                @else
                        @if($registro->revisadoS2 == '1')
                        <td class="text-center"><a href="#" hidden>{{$registro->id}}</a><a href="seleccionMaxima/{{$registro->id}}"><b>Nuevo <i class="fa fa-eye" aria-hidden="true"></i> {{$registro->cedula}}</b></a></td>
                        @else
                        <td class="text-center"><a href="#" hidden>{{$registro->id}}</a><a href="seleccionMaxima/{{$registro->id}}">{{$registro->cedula}}</a></td>
                        @endif
                @endif
                        ...
                        <td class="text-center"><a href="seleccionMaxima/{{$registro->id}}"><i style="color:#8E2121;" class="fa fa-eye fa-2x" aria-hidden="true"></i></a></td>
