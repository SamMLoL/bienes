        ...
        <div class="col-md-12">
            <div class="row">
                <div class="panel">
                   ...
                   <div class="panel-heading text-center"><h5><b>MODIFICAR DATOS DE LOS BIENES <i class="fa fa-pencil-square-o" aria-hidden="true"></i></b></h5></div>
                </div>
            </div>
...
<!--FIN DEL PRIMER ROW DE INPUT-->
            <div class="row separar">
                ...
                <div class="col-md-4 form-group">
                    <li><b>Código de la Marca del Componente:</b></li>
                ...
                <div class="col-md-4 form-group">
                  <li><b>Código Modelo del Componente:</b></li>
