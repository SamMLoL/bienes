                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                       <label for="codigo">Código</label>
                          <input type="text" class="form-control" name="codigo" id="codigo" value="{{$form_t7->codigo}}"  placeholder="Introduzca nombres" maxlength="30"> 
                    </div>
                    ...
                    <div class="col-md-4">
                       <label for="codBienMueble">Código del Bien mueble</label>   
                          <input type="text" class="form-control" name="codBienMueble" id="codBienMueble" value="{{$form_t7->codBienMueble}}"  placeholder="Introduzca nombres" maxlength="100" autofocus> 
                    </div>
                </div>
            </div>
