			...
			<div class="row separar40 ">
			  	<div class="col-md-12">
					<div class="col-md-4">
						...
						<input type="text" class="form-control" name="codOt2_5" id="codOt2_5" value="F-1" maxlength="12">
						@else
					...
					<div class="col-md-4 form-group">
		               ...
		               <select name="codAdq" id="codAdq" class="form-control">
		                  ...
		                  @foreach($infoSelect as $form)
		                  	@if($form->id != $form_t25->selectExpropiacion->id)
			...
			<div class="row separar40">
				<div class="col-md-12">	
					...
					<div class="col-md-4">
						...
						@else
						 <input type="text" class="form-control" name="folio" id="folio" value="{{$form_t25->folio}}" maxlength="6" onkeypress="return soloNum(event)">
						@endif
					</div>
				</div>
			</div>
