	        ...
	        <div class="row separar40">
	        	<div class="col-md-12">
					...
					<div class="col-md-4">
						...
						@if($form_t26->feCon == '1111-11-11')
						 <input type="text" class="form-control calendario" name="feCon" id="feCon" value="11111111" maxlength="10">
						@else
						 <input type="text" class="form-control calendario" name="feCon" id="feCon" value="{{$form_t26->feCon}}" maxlength="10">
						@endif
				    </div>
				</div>
			</div>
