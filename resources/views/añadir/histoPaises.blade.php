...
<div class="row">
    <div class="col-md-12">
        <div class="row separar">
            <div class="col-md-12">
              <center><h4><b>Añadir Países</b> <i id='color' class="fa fa-plus-circle"></i></h4></center>
            </div>
        </div>
    <hr>
        <div class="row">
            ...
            <tbody>
                ...
                @foreach($verPais as $im)
                  ...
                  <tr>
                        ...
                        <td class="text-center"><a href="#" hidden>{{$im->id}}</a><a href="seleccionPaises/{{$im->id}}"><b>Nuevo <i class="fa fa-eye" aria-hidden="true"></i> {{$im->codigo}}</b></a></td>
                        @else 
                        <td class="text-center"><a href="#" hidden>{{$im->id}}</a><a href="seleccionPaises/{{$im->id}}"> {{$im->codigo}}</a></td>
                        @endif
                  @else
                        @if($im->revisadoAddPais == '1')
                        <td class="text-center"><a href="#" hidden>{{$im->id}}</a><a href="seleccionPaises/{{$im->id}}"><b>Nuevo <i class="fa fa-eye" aria-hidden="true"></i> {{$im->codigo}}</b></a></td>
